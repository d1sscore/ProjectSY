...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.img_add = tk.PhotoImage(file="D:\\python\\project\\add.png")
        ...
        self.img_upd = tk.PhotoImage(file="D:\\python\\project\\change.png")
        ...
        # Кнопка поиска
        self.img_search = tk.PhotoImage(file="D:\\python\\project\\search.png")
        ...
        # Кнопка обновления
        self.img_refresh = tk.PhotoImage(file="D:\\python\\project\\refresh.png")
        ...
        self.tree.heading("salary", text="Зарабатная-плата")
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        self.btn_add.place(x=265, y=160)
...
class Update(Child):
    ...
    def init_update(self):
        ...
        self.btn_upd.place(x=265, y=160)
